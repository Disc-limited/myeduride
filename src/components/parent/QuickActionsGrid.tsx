  ...
  const actions = [
    {
      ...
      fullLabel: 'Safety Connect Command Center',
      description: 'Unified mobility hub: School Escort, MyEduRide Escort & E-Drive',
      icon: ShieldCheck,
      bgColor: 'bg-emerald-600 text-white shadow-xs',
      hoverColor: 'hover:bg-emerald-700',
    },
    {
      key: 'school_escort',
      label: 'School Escort',
      fullLabel: 'School Escort Profile & Specs',
      description: 'View assigned school escort credentials, vehicle & route schedule',
      icon: UserCheck,
    ...
    {
      key: 'book_ride',
      label: 'MyEduRide Escort',
      fullLabel: 'Request MyEduRide Backup Escort',
      description: 'Request a verified backup escort when school escort is unavailable',
      icon: Sparkles,
    ...
    {
      key: 'track_vehicle',
      label: 'E-Drive Tracking',
      fullLabel: 'Live Vehicle GPS & Telemetry',
      description: 'Live shuttle tracking, speed limit gauge, and stop ETA',
      icon: Navigation,
    ...
    },
    {
      key: 'fund_wallet',
      label: 'Parent Wallet',
      fullLabel: 'Parent Wallet & Credits',
      description: 'Review wallet balance and automated ride payments',
      icon: Wallet,
