...
export async function GET(request: NextRequest) {
  try {
    ...
    const base = {
      ...
      journeyStage,
      isSafeAtHome,
      isNotReadyYet: todayTrip?.readiness_status === 'not_ready' || Boolean(todayTrip?.is_not_ready_yet),
      delayedMinutes: todayTrip?.delayed_minutes || null,
      shiftedPickupTime: todayTrip?.shifted_pickup_time || null,
      notReadyReason: todayTrip?.not_ready_reason || null,
