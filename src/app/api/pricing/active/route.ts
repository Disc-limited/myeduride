  ...
  try {
    ...
    return NextResponse.json({
      ...
      pricing: {
        ...
        rate_per_half_km: config.rate_per_half_km,
        rate_per_tenth_km: config.rate_per_tenth_km,
    ...
    if (/city_pricing|relation|does not exist/i.test(message)) {
      return NextResponse.json({
        ...
        pricing: {
          ...
          version: 1,
          last_reason: 'Default platform rates (run migration 021_city_pricing.sql)',
