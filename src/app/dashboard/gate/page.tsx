...
export default function GateOfficerDashboard() {
  ...
  // Mock Queue items if DB queue is small for visualization matching design
  const displayQueue = useMemo(() => {
    if (filteredQueue.length >= 5) return filteredQueue;

    const mockAdditions = [
      {
        id: 'mock-1',
        student: { id: 'm1', first_name: 'David', last_name: 'Johnson', student_id_number: '20221045', class: { name: 'Primary 4 Gold' }, photo_url: null },
        ready_since: '10:05 AM',
        escort_name: 'Mr. Peter Johnson',
        relationship: 'Father',
        status: 'Escort Arrived',
        status_type: 'arrived',
      },
      {
        id: 'mock-2',
        student: { id: 'm2', first_name: 'Sarah', last_name: 'Williams', student_id_number: '20221046', class: { name: 'Primary 4 Gold' }, photo_url: null },
        ready_since: '10:07 AM',
        escort_name: 'Mrs. Grace Williams',
        relationship: 'Mother',
        status: 'Escort Arrived',
        status_type: 'arrived',
      },
      {
        id: 'mock-3',
        student: { id: 'm3', first_name: 'Emmanuel', last_name: 'Paul', student_id_number: '20221048', class: { name: 'Primary 4 Gold' }, photo_url: null },
        ready_since: '10:10 AM',
        escort_name: 'MyEduRide Escort',
        relationship: 'EDU-1023',
        status: 'Escort Arrived',
        status_type: 'arrived',
        is_official_escort: true,
      },
      {
        id: 'mock-4',
        student: { id: 'm4', first_name: 'Chiamaka', last_name: 'Okafor', student_id_number: '20221050', class: { name: 'Primary 4 Gold' }, photo_url: null },
        ready_since: '10:12 AM',
        escort_name: 'Aunty Mary Okafor',
        relationship: 'Aunt',
        status: 'Escort Arrived',
        status_type: 'arrived',
      },
      {
        id: 'mock-5',
        student: { id: 'm5', first_name: 'Ibrahim', last_name: 'Sani', student_id_number: '20221052', class: { name: 'Primary 4 Gold' }, photo_url: null },
        ready_since: '10:15 AM',
        escort_name: 'Mr. Ahmed Sani',
        relationship: 'Uncle',
        status: 'Waiting Escort',
        status_type: 'waiting',
      },
    ];

    return [...filteredQueue, ...mockAdditions].slice(0, 5);
  }, [filteredQueue]);
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans antialiased text-slate-900">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <aside
          className={`w-60 bg-[#0b1928] text-white flex flex-col justify-between shrink-0 shadow-xl transition-transform duration-300 md:translate-x-0 ${
            mobileOpen ? 'fixed left-0 top-[57px] bottom-0 z-50 translate-x-0' : 'hidden md:flex'
          }`}
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
            ...
            <div className="bg-white rounded-2xl p-3.5 border border-slate-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-all">
              ...
              <div className="mt-2">
                ...
                <p className="text-xl font-black text-slate-900 leading-none mt-1">342</p>
                <p className="text-[9px] text-emerald-600 font-bold mt-1">↑ 12% from yesterday</p>
              </div>
              <button className="text-[10px] font-bold text-emerald-700 hover:underline text-left mt-2">
                View Details
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-3.5 border border-slate-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-all">
              ...
              <div className="mt-2">
                <p className="text-[10px] font-bold text-slate-400 uppercase">Staff Checked In</p>
                <p className="text-xl font-black text-slate-900 leading-none mt-1">48</p>
                <p className="text-[9px] text-blue-600 font-bold mt-1">↑ 8% from yesterday</p>
              </div>
              <button className="text-[10px] font-bold text-blue-700 hover:underline text-left mt-2">
                View Details
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-3.5 border border-slate-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-all">
              ...
              <div className="mt-2">
                ...
                <p className="text-xl font-black text-slate-900 leading-none mt-1">178</p>
                <p className="text-[9px] text-emerald-600 font-bold mt-1">↑ 15% from yesterday</p>
              </div>
              <button className="text-[10px] font-bold text-teal-700 hover:underline text-left mt-2">
                View Details
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-3.5 border border-slate-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-all">
              ...
              <div className="mt-2">
                ...
                <p className="text-xl font-black text-slate-900 leading-none mt-1">36</p>
                <p className="text-[9px] text-amber-700 font-bold mt-1">Now at gate</p>
              </div>
              <button className="text-[10px] font-bold text-amber-700 hover:underline text-left mt-2">
                View Details
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-3.5 border border-slate-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-all">
              ...
              <div className="mt-2">
                ...
                <p className="text-xl font-black text-slate-900 leading-none mt-1">15</p>
                <p className="text-[9px] text-slate-400 font-medium mt-1">Registered</p>
              </div>
              <button className="text-[10px] font-bold text-purple-700 hover:underline text-left mt-2">
                View Details
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-3.5 border border-slate-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-all">
              ...
              <div className="mt-2">
                ...
                <p className="text-xl font-black text-slate-900 leading-none mt-1">
                  {pickupQueue.length > 0 ? pickupQueue.length : 22}
                </p>
                <p className="text-[9px] text-amber-700 font-bold mt-1">In queue</p>
              </div>
              <button className="text-[10px] font-bold text-amber-800 hover:underline text-left mt-2">
                View Details
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-3.5 border border-slate-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-all">
              ...
              <div className="mt-2">
                ...
                <p className="text-xl font-black text-slate-900 leading-none mt-1">2</p>
                <p className="text-[9px] text-red-600 font-bold mt-1">Requires review</p>
              </div>
              <button className="text-[10px] font-bold text-red-700 hover:underline text-left mt-2">
                View Details
              </button>
            </div>
          </div>
            ...
            <div id="ready-pickup-queue" className="lg:col-span-5 bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-xs flex flex-col justify-between">
                        ...
                        return (
                          <tr key={item.id || idx} className="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td className="py-3 px-3 font-medium text-slate-700">
                              {s.class?.name || 'Primary 4 Gold'}
                            </td>
                            <td className="py-3 px-3 font-semibold text-slate-600">
                              {item.ready_since || '10:05 AM'}
                            </td>
                            <td className="py-3 px-3">
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <p className="font-bold text-slate-900 text-[11px] leading-tight">
                                    {item.escort_name || 'Mr. Peter Johnson'}
                                  </p>
                            ...
                            <td className="py-3 px-3 text-right">
                              {item.status_type === 'waiting' ? (
                                <button
                                  ...
                                  className="px-2.5 py-1 rounded-lg border border-slate-300 hover:bg-slate-100 text-slate-700 font-bold text-[10px]"
                                >
                                  View Details
                                </button>
                              ) : (
                                <button
                                  type="button"
                                  onClick={() => handleReleaseClick(s, item)}
                                  className="px-2.5 py-1 rounded-lg border border-emerald-600 hover:bg-emerald-50 text-emerald-700 font-extrabold text-[10px] shadow-2xs"
                                >
                                  Verify & Release
                                </button>
                              )}
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-emerald-700">
                <button type="button" className="hover:underline flex items-center gap-1">
                  View All (22) <ChevronDown size={14} />
                </button>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-xs flex flex-col justify-between">
              <div>
                ...
                <div className="grid grid-cols-3 gap-2.5">
                  ...
                  <button
                    type="button"
                    onClick={() => toast.info('Quick Verify scanner ready')}
                    className="p-3 bg-slate-50 hover:bg-blue-50 border border-slate-200 hover:border-blue-200 rounded-xl flex flex-col items-center justify-center text-center transition-all group shadow-2xs"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => toast.warning('Override Release authorization code required')}
                    className="p-3 bg-slate-50 hover:bg-amber-50 border border-slate-200 hover:border-amber-200 rounded-xl flex flex-col items-center justify-center text-center transition-all group shadow-2xs"
                  >
                ...
                <div className="flex gap-1 bg-slate-100 p-1 rounded-xl mb-3 text-xs font-bold">
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-lg text-center transition-all ${
                      chatTab === 'chats' ? 'bg-white text-slate-900 shadow-2xs' : 'text-slate-500 hover:text-slate-900'
                    }`}
                  >
                    Chats
                  </button>
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-lg text-center transition-all ${
                      chatTab === 'groups' ? 'bg-white text-slate-900 shadow-2xs' : 'text-slate-500 hover:text-slate-900'
                    }`}
                  >
                    Groups
                  </button>
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-lg text-center transition-all ${
                      chatTab === 'broadcast' ? 'bg-white text-slate-900 shadow-2xs' : 'text-slate-500 hover:text-slate-900'
                    }`}
                  >
                    Broadcast
                  </button>
            ...
            <div className="lg:col-span-4 bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-xs flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-2 text-xs">
                  {[
                    { name: 'David Johnson', releasedTo: 'Mr. Peter Johnson (Father)', gate: 'Gate A', time: '10:20 AM' },
                    { name: 'Sarah Williams', releasedTo: 'Mrs. Grace Williams (Mother)', gate: 'Gate A', time: '10:18 AM' },
                    { name: 'Emmanuel Paul', releasedTo: 'MyEduRide Escort (EDU-1023)', gate: 'Gate A', time: '10:16 AM' },
                    { name: 'Chiamaka Okafor', releasedTo: 'Aunty Mary Okafor (Aunt)', gate: 'Gate A', time: '10:14 AM' },
                    { name: 'Ibrahim Sani', releasedTo: 'Mr. Ahmed Sani (Uncle)', gate: 'Gate A', time: '10:12 AM' },
                  ].map((rel, i) => (
                    <div key={i} className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-between">
                      <div className="flex items-center gap-2.5 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-slate-500 truncate">Released to {rel.releasedTo}</p>
                        </div>
                      </div>
                      <div className="text-right shrink-0 ml-2">
                        <span className="text-[10px] font-bold text-slate-700">{rel.time}</span>
                        <span className="text-[9px] text-slate-400 block">{rel.gate}</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="lg:col-span-4 bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-xs flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button className="text-xs font-bold text-emerald-700 hover:underline">View Full Report</button>
                </div>
                ...
                <div className="grid grid-cols-4 gap-2 text-center">
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <p className="text-base font-black text-slate-900 mt-0.5">125</p>
                  </div>
                  ...
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <p className="text-base font-black text-slate-900 mt-0.5">36</p>
                  </div>
                  ...
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <p className="text-base font-black text-slate-900 mt-0.5">12</p>
                  </div>
                  ...
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <p className="text-base font-black text-slate-900 mt-0.5">78</p>
                  </div>
                  ...
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <p className="text-base font-black text-slate-900 mt-0.5">1</p>
                  </div>
                  ...
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <p className="text-base font-black text-slate-900 mt-0.5">18 sec</p>
                  </div>
                  ...
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <p className="text-base font-black text-slate-900 mt-0.5">164</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/70 flex items-center justify-center p-4 backdrop-blur-xs">
          <div className="bg-white rounded-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto border border-slate-200 shadow-2xl">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 mb-4">
              ...
              <button onClick={() => setReleaseStudent(null)} className="text-slate-400 hover:text-slate-600">
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex gap-3 pt-5 border-t border-slate-100 mt-4">
              <button
                ...
                className="flex-1 py-2.5 border border-slate-300 rounded-xl font-bold text-xs text-slate-700 hover:bg-slate-50"
              >
                Cancel
              </button>
              <button
                type="button"
                onClick={async () => {
                  toast.success(`Student ${releaseStudent.student?.first_name || ''} successfully released!`);
          ...
          <div className="bg-white rounded-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto border border-slate-200 shadow-2xl">
            ...
            <form
              onSubmit={async (e) => {
                ...
                toast.success(`Visitor ${name} registered successfully!`);
            ...
            >
              <div>
                ...
                <input required name="visitorName" type="text" placeholder="e.g. Mr. Chidi Okafor" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs" />
              </div>
              <div>
                <label className="block text-slate-700 mb-1">Phone Number</label>
                <input required name="visitorPhone" type="tel" placeholder="e.g. 0803 123 4567" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-mono" />
              </div>
              <div>
                <label className="block text-slate-700 mb-1">Purpose of Visit / Person to See</label>
                <input required name="visitPurpose" type="text" placeholder="e.g. Meeting with Principal" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs" />
              </div>
              <div className="flex gap-3 pt-3">
                <button type="button" onClick={() => setShowVisitorModal(false)} className="flex-1 py-2.5 border border-slate-300 rounded-xl font-bold text-slate-700">Cancel</button>
                <button type="submit" className="flex-1 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold shadow-md">Register Entry</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto border border-slate-200 shadow-2xl">
            ...
            <form
              onSubmit={async (e) => {
                ...
                toast.success(`Incident report (${category}) logged!`);
            ...
            >
              <div>
                ...
                <select name="category" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs">
              ...
              <div>
                ...
                <textarea required name="description" rows={3} placeholder="Describe what happened at the gate..." className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs" />
              </div>
              <div className="flex gap-3 pt-3">
                <button type="button" onClick={() => setShowIncidentModal(false)} className="flex-1 py-2.5 border border-slate-300 rounded-xl font-bold text-slate-700">Cancel</button>
                <button type="submit" className="flex-1 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-bold shadow-md">Submit Incident Report</button>
              </div>
            </form>
          </div>
        </div>
