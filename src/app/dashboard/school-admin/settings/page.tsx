  ...
  const loadSettings = useCallback(async (id) => {
    ...
    try {
      ...
      if (data.school?.logo_url) {
        setLogoPreview(photoSrc(data.school.logo_url));
      }
      if (data.school?.principal_signature_url) {
        setSignaturePreview(photoSrc(data.school.principal_signature_url));
      }
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen pt-14 md:pt-6">
      ...
      <div className="flex gap-4 border-b border-gray-200 mb-6">
        <Link href="/dashboard/school-admin/settings" className="px-4 py-2 border-b-2 border-primary-600 text-primary-700 font-medium text-sm">
          General Settings
        </Link>
        <Link href="/dashboard/school-admin/settings/gate-setup" className="px-4 py-2 text-gray-500 hover:text-gray-700 font-medium text-sm">
          Gate Setup
        </Link>
      </div>
                  ...
                  <input
                    ...
                    onChange={async (e) => {
                      ...
                      try {
                        ...
                        setLogoPreview(data.preview_url || photoSrc(data.path));
                  ...
                  <input
                    ...
                    onChange={async (e) => {
                      ...
                      try {
                        ...
                        setSignaturePreview(data.preview_url || photoSrc(data.path));
