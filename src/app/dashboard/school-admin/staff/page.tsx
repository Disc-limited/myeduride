        ...
        {staff.map((s) => (
          <div key={s.user_id || s.id} className="list-row gap-4 flex-wrap sm:flex-nowrap">
            ...
            <div className="flex-1 min-w-0">
              ...
              {s.staff?.class_name && (
                <p className="text-xs text-primary-700 font-medium">Class: {s.staff.class_name}</p>
              )}
              {!s.staff?.photo_url && (
            ...
            <button
              ...
              className="p-2 rounded-xl hover:bg-slate-50 text-slate-400 hover:text-slate-600 shrink-0"
